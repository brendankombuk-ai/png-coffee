    ...
    >
      ...
      <div className="space-y-2 px-5 pb-6 pt-5 text-center">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-full border border-ember-400/30 bg-ember-500/15 px-5 py-2 text-xs font-bold uppercase tracking-widest text-white/90 transition-colors duration-300 hover:border-ember-400/70 hover:bg-ember-500/25 hover:text-ember-100 disabled:cursor-not-allowed disabled:opacity-50"
        >
          {justAdded ? (
            <>
