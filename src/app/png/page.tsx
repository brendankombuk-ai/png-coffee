...
import { getPngTourism, getTourismCards, getPageSeo } from "@/lib/cms/adapters";
...
export async function generateMetadata(): Promise<Metadata> {
  const seo = await getPageSeo("pngCoffeePage");
  const description = seo.seoDescription ?? FALLBACK_DESCRIPTION;
  return {
    title: seo.seoTitle ?? "Papua New Guinea",
    description,
    openGraph: {
      title: `${seo.seoTitle ?? "Papua New Guinea"} – ${site.name}`,
      description,
    },
  };
}
